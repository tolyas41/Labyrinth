...
void ALabyrinthCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ALabyrinthCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ALabyrinthCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ALabyrinthCharacter::OnResetVR);
}


void ALabyrinthCharacter::OnResetVR()
{
	// If Labyrinth is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Labyrinth.Build.cs is not automatically propagated
...
void ALabyrinthCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ALabyrinthCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
